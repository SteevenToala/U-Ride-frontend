...
class _ClientHistoryTripPageState extends State<ClientHistoryTripPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ClientHistoryTripBloc, ClientHistoryTripState>(
        ...
        child: LayoutBuilder(builder: (context, constraints) {
          ...
          if (cols == 1) {
            return ListView.builder(
              ...
              itemBuilder: (context, i) => Padding(
                ...
                child: ClientHistoryTripItem(data[i]),
              ),
            );
          }
          ...
          return SingleChildScrollView(
            ...
            child: Wrap(
              ...
              runSpacing: spacing,
              children: data
                  .map((r) => SizedBox(width: cardW, child: ClientHistoryTripItem(r)))
                  .toList(),
            ),
          );
        }),
